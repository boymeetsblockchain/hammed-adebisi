    ...
    <div className="education my-5">
      ...
      <div className="edu-box flex flex-col items-center md:flex-row space-y-5 gap-8 md:space-y-0">
        <div className="higher shadow-lg p-4 rounded-md my-3 md:w-1/2">
          ...
          <div className="edu-entry flex space-y-3 justify-between">
            <p className="flex items-center"><span className="inline text-green-600 mr-2"><AiOutlineCheckCircle /></span> University of Benin, Benin City</p>
        ...
        <div className="higher shadow-lg p-4  my-3 md:w-1/2 rounded-md">
          ...
          <div className="edu-entry flex space-y-3 justify-between">
            <p className="flex items-center"><span className="inline text-green-600 mr-2"><AiOutlineCheckCircle /></span> Master of Science (Education) in Exercise Physiology</p>
            <p className="ml-8">2018</p>
          </div>
          <div className="edu-entry flex space-y-3 justify-between">
            <p className="flex items-center"><span className="inline text-green-600 mr-2"><AiOutlineCheckCircle /></span> Doctor of Philosophy (Ph.D.) in Exercise Physiology</p>
