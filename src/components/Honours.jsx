  ...
  return (
    <div className="honours my-10  py-5 px-3 ">
      ...
      <div className=" flex flex-col items-start justify-center shadow-2xl py-4 px-3 space-y-6">
        <p className="  flex items-center text-gray-700"><span className="inline text-green-700 mr-2"><GiAchievement size={24}/></span>Year 2008/2009 Scholarship Award - Offered by Ministry of Education Oyo State Scholarship Scheme (2010).</p>
